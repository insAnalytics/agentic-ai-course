...
/src
  ...
  /components
    ...
    /lesson                     # components implementing lesson-structure.md
      ...
      NextTokenDistribution.tsx    # prompt picker + bar chart of a small curated bank's real GPT-2 next-token probabilities (src/data/next-token-distributions.json) — Lesson 1.4
