...
/src
  ...
  /components
    ...
    /lesson                     # components implementing lesson-structure.md
      ...
      EmbeddingSpace.tsx           # 2D scatter of real GloVe-derived word positions (src/data/embedding-words.json) plus a type-a-word-to-add box; runs its own label-collision-avoidance pass — Lesson 1.2
