...
/src
  ...
  /components
    ...
    /lesson                     # components implementing lesson-structure.md
      ...
      DecodingPlayground.tsx       # same real GPT-2 bank as NextTokenDistribution.tsx, plus a greedy/sampling toggle -- greedy highlights the argmax, sampling draws a genuine client-side weighted-random token from the real (renormalized top-8) probabilities on every "Sample again" click — Lesson 1.5
