...
This replaces the manual tally-building pattern from the dicts concept in cases
...
assert available_tool_names(configs) == ["search", "memory"]`,
  ...
  correctAnswer={{
    ...
    explanation:
      "This combines dict key access from the dicts concept with the list comprehension filter pattern from this concept — one line replacing what would otherwise be a 4-line loop-and-append.",
  }}
/>
