...
as [reassigning a variable inside a function creating a new local instead of touching the outer one](/00-python-essentials/03-functions-and-reuse/03-scope/#reading-an-outer-variable-works-reassigning-it-doesn-t-without-global)
...
shape as [the mutable default argument trap](/00-python-essentials/03-functions-and-reuse/03-scope/#the-mutable-default-argument-trap):
